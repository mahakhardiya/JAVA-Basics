...
//and an integer target, return the index of target if it is in nums, or -1   
//if it is not in nums.You must write an algorithm with O(log n) 
//runtime complexity.
//Example 1: 
//Input:nums = [4, 5, 6, 7, 0, 1, 2], target = 0 Output:   4 Example 2:Input:nums = [4,  5, 6, 7, 0, 1, 2], target = 3Output:   -1 mahakhardiya@gmail.com
